...
setup(
    ...
    install_requires=["rdflib", "pandas, sqlite3, math; python_version>='3.8'", "numpy>=1.19.5; python_version>='3.8'; "numpy>=1.18.5, <=1.19.5; python_version<'3.8'"], #'pandas; python_version >= 3.8'], #"numpy <= 1.19.5"], # "sqlite3","math", "multiprocessing","numpy<=1.19.5"
)
